...
import { X, Calendar, Users, Gamepad2, Hash,IndianRupeeIcon } from 'lucide-react';
          ...
          <div className="grid gap-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <label className="mb-1.5 block text-xs text-white/70">
                  <span className="inline-flex items-center gap-1">
                    <IndianRupeeIcon className="h-4 w-4" /> Entry Fee (₹)
                  </span>
                </label>
                <div className="relative">
                  <IndianRupeeIcon className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-white/50" />
                  <input
                    type="number"
                    name="entryFee"
                    min="0"
