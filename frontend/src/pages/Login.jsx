...
import { Gamepad2, Mail, Lock, Eye, EyeOff, AlertCircle, Loader2, CheckCircle2 } from 'lucide-react';
    ...
    <div className="min-h-screen relative flex items-center justify-center p-6">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-white/70">Sign in to continue competing</p>
        </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-xl border px-10 py-2.75 text-sm text-white outline-none placeholder:text-white/40 bg-white/5
                    ...
                    ${errors.email ? 'ring-2 ring-rose-500/40 border-rose-500/40' : ''}`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-xl border px-10 py-2.75 text-sm text-white outline-none placeholder:text-white/40 bg-white/5
                    focus:border-white/20 focus:ring-2 focus:ring-indigo-500/30 border-white/10
                    ${errors.password ? 'ring-2 ring-rose-500/40 border-rose-500/40' : ''}`}
                  placeholder="••••••••"
                  value={form.password}
                  onChange={onChange}
